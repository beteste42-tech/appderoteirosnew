  ...
  useEffect(() => {
    ...
    if (!mapInstanceRef.current) {
      ...
      const markerPartida = new google.maps.Marker({
        ...
        title: `${PONTO_PARTIDA.nome} - Ponto de Partida`,
        icon: {
      ...
      const infoWindowPartida = new google.maps.InfoWindow({
        content: `
          <div style="padding: 8px; max-width: 250px;">
            <h3 style="color: #ff0000; margin: 0 0 5px 0;">PONTO DE PARTIDA</h3>
    ...
    <div>
      <div className="mb-3 p-3 bg-gray-100 dark:bg-slate-700 rounded-lg flex items-center justify-between">
        <div className="flex items-center">
          ...
          <span className="text-sm">Ponto de Partida: {PONTO_PARTIDA.nome}</span>
        </div>
        {distanciaTotal > 0 && (
